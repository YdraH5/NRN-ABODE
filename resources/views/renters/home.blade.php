    ...
    <div class="py-12">
        <div class="min-w-full mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-lg shadow-lg mb-6 p-6">
                ...
                <p class="mt-4 text-red-500 font-semibold">You can extend your rental period at any time. Click the button below to extend your contract.</p>
                <button 
                            ...
                            <tr class="hover:bg-gray-100">
                                ...
                                <td class="px-4 py-3 border-b border-gray-300 lg:table-cell sm:hidden">
                                    ...
                                    <div x-data="{ showWarning: false }" class="relative flex flex-col items-start">
                                        ...
                                        @if($index < 2 && !$isPaid)
                                            <p class="mt-2 text-red-500 font-semibold">Required payment in advance now</p>
                                        @endif
