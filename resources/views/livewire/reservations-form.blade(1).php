      ...
      <div class="flex flex-row items-center justify-center space-y-4 lg:space-y-0 lg:space-x-8 bg-white shadow-md rounded-lg p-4">
        <div class="max-w-2xl w-full">
          <div class="relative text-center">
            ...
            <button
                wire:click="reserve({{$detail->id}})"
                type="button"
                class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded mt-4 focus:outline-none focus:ring-2 focus:ring-blue-500">Reserve
            </button>
          </div>
        </div>
      </div>     
