...
<div class="relative text-center px-6 md:px-12">
    <h1 class="text-4xl md:text-6xl font-bold">Explore the World</h1>
    <p class="mt-4 text-lg md:text-xl opacity-80 max-w-lg mx-auto">
        We're constantly trying to express ourselves and actualize our dreams. If you have the opportunity to play this game, take it.
    </p>
    <a href="#about-us">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8 min-w-full px-4 md:px-16">
                        @foreach ($categories as $category)
                            <div class="bg-white shadow-lg rounded-lg overflow-hidden transition-transform transform hover:scale-105 hover:bg-slate-200">
                                ...
                                <!-- Add carousel and description code here -->
                            </div>
                        @endforeach
                    </div>
                </div>
        ...
        <!-- Location Section -->
        <div id="location" class="text-black flex flex-col items-center justify-center p-4 md:p-5 text-center my-2"data-aos="fade-up">
            ...
            <div class="text-center">
                @if($owner)
                    <div class="bg-white py-8 text-center text-black">
                        <h2 class="text-2xl md:text-3xl font-semibold mb-4 text-black">CONTACT US</h2>
