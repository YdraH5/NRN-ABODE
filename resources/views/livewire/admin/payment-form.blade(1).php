                ...
                <div class="grid md:grid-cols-2 gap-4">
                    ...
                    @if($dueDates && $dueDates->count())
                        <div class="col-span-1">
                            ...
                            <input 
                                type="text" 
                                value="{{ \Carbon\Carbon::parse($dueDates->first()->payment_due_date)->format('F j, Y') }}" 
                                readonly 
                                class="mt-2 text-gray-600 bg-gray-100 font-normal w-full h-10 flex items-center pl-3 text-sm border-gray-300 rounded border"
                            >
                            <input type="hidden" wire:model="duedate_id" value="{{ $dueDates->first()->id }}">
                        </div>
                    @else
                        <div class="col-span-1">
